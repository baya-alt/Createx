...
const addToCart = (product, size, color, quantity = 1, imageUrl) => {
    ...
    const item = {
        ...
        quantity: quantity,
        color: color,
        imageUrl: imageUrl || product.avatar || product.avataryellow || "",
...
function Content({ product, onAddToCartNotification, onSizeWarning, onFavoriteAdded }) {
    // Формируем список доступных цветов для men
    ...
    useEffect(() => {
        const favorites = JSON.parse(localStorage.getItem('favorites')) || [];
        const activeColorName = getActiveColorLabel();
    ...
    const activeColorLabel = getActiveColorLabel();
    ...
    const handleAddToCart = () => {
        ...
        const addedItem = addToCart(product, activeSize, activeColorLabel, quantity, activeImage);
    ...
    const handleFavoriteClick = () => {
        const activeImage = colorMap[index - 1]?.src || product.avatar;
        const result = addToFavorites(product, activeColorLabel, activeImage);
        ...
        <div className="product-layout">
            ...
            <div className="text-info-column">
                <p className="intro-text">
                    Premium comfort and style for men.
                ...
                <section className="info-block">
                    ...
                    <ul className="info-list">
                        <li><strong>Brand:</strong> Men's Collection</li>
                        <li>Classic men's design</li>
                        <li>Secure fastening system</li>
                        <li>Durable soles</li>
                ...
                <section className="info-block">
                    ...
                    <ul className="info-list">
                        <li><strong>Upper:</strong> Premium men's materials</li>
                        <li><strong>Lining:</strong> Soft breathable fabric</li>
                        <li><strong>Sole:</strong> Durable non-slip rubber</li>
                    </ul>
                </section>
                ...
                <section className="info-block">
                    <h4 className="info-subtitle">Features</h4>
                    <ul className="info-list">
                            ...
                            <div className="selector-group">
                                ...
                                <div className="colors-block">
                                    {colorMap.map((color, i) => (
                                        <span
                                            key={color.name}
                                            className={`dot d-${color.name} ${activeColorLabel === color.label ? "active" : ""}`}
                                ...
                                {activeColorLabel && (
                                    <p className="selected-color-text">Selected: {activeColorLabel}</p>
                                )}
                            </div>
